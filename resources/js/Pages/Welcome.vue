...
<template>
    <div class="">
            ...
            <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
                <div class="flex lg:flex-1">
                    <a href="#" class="-m-1.5 p-1.5">
                        ...
                        <img class="h-8 w-auto" src="../../../public/img/brain-ai.png" alt="">
                    </a>
                </div>
        ...
        <div class="relative isolate overflow-hidden bg-gray-900">
            ...
            <div class="flex justify-center mx-auto px-6 pb-24 pt-10 sm:pb-32 lg:flex  lg:py-40">
                <div class="">
                    <div class="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl ">
                        <!-- <img class="h-11" src="../../../public/img/brain-ai.png" alt="Your Company"> -->

                        <h1 class="mt-10 lg-m:text-2xl text-4xl font-bold tracking-tight text-white sm:text-6xl">Phasor -
                            Australian
                            electrical & construction standards AI chatbot</h1>
                        <p class="mt-6 lg-m:text-lg text-lg leading-8 text-gray-300">Welcome to our AI-powered Chatbot: your
                            virtual
                            companion for navigating the intricacies of Australian Electrical Standards. Whether you're an
                            electrician, an engineer, a business owner, or simply someone interested in understanding
                            electrical
                            regulations, our chatbot is here to provide you with accurate and up-to-date information.</p>

                    </div>
                    <div class="hidden lg:flex lg:flex-1 mt-4">
                        <a href="/login" class="text-lg font-semibold leading-6 text-white">Log in<span
                                aria-hidden="true">&rarr;</span></a>
                    </div>
                </div>
                <div
                    ...
                    <div class="max-w-3xl  flex-none sm:max-w-5xl lg:max-w-none">
                        <img src="../../../public/img/brainAiBig.png" alt="App screenshot"
                            class="w-[46rem] lg-m:w-[30rem] rounded-md bg-white/5 shadow-2xl ring-1 ring-white/10">
                    </div>
                </div>
        ...
        <div class="flex  bg-gray-900 flex-col justify-center items-center md:h-[100vh] ">

            <div class=" mb-20 md-m:mt-20 text-center  text-4xl">
                <p class="font-black text-white text-bold ">Choose your assistant...</p>
            </div>
            ...
            <div class="md:flex">
                <div class="lg-m:mt-4 drop-shadow-lg md:mr-4 ">
                    <div class="bg-white pt-1 pb-3 w-full relative shadow px-2 rounded-3xl ">
                        ...
                        <div class=" absolute top-5 left-2 pointer-events-none  inset-y-0 pl-3">
                            <img src="../../../public/img/bolt.png" class="h-6 w-7 text-green-400" aria-hidden="true" />
                        </div>
                        ...
                        <div class="h-[14rem] w-[16rem]">
                            <ul class="text-gray-500 text-sm">
                                <li class="py-2  px-1 my-0.5 rounded-md cursor-pointer hover:bg-gray-200">
                                    Unlimited
                                    usage</li>
                                <li class="py-2  px-1 my-0.5 rounded-md cursor-pointer hover:bg-gray-200">Three
                                    login
                                    devices</li>

                                <li class="py-2 w-[16rem] px-1 my-0.5 rounded-md cursor-pointer hover:bg-gray-200">
                                    Trained on the AS/NZ 3000:2018 with all amendments
                                </li>
                        ...
                        <div class="flex justify-between items-end">
                            ...
                            <a href="register"> <button
                                    class=" py-1 px-4 text-white text-sm rounded-2xl bg-[#b30059] hover:bg-[#7a204d]">Choose</button>
                            </a>
                ...
                <div class=" lg-m:mt-4 drop-shadow-lg">
                    <div class="bg-white  pb-3 pt-1 w-full relative shadow  px-2 rounded-3xl ">
                        ...
                        <div class=" absolute top-5 left-2 pointer-events-none  inset-y-0 pl-3">
                            <img src="../../../public/img/workersetting.png" class="h-7 w-7 text-green-400"
                                aria-hidden="true" />
                        </div>
                        <div class=" pt-4 flex justify-center">
                        ...
                        <div class=" h-[14.4rem] w-[16rem]">
                            <ul class="text-gray-500 text-sm">
                                <li class="py-2  px-1 my-0.5 rounded-md cursor-pointer hover:bg-gray-200">
                                    Everything a house-basher gets +
                                </li>
                                <li class="py-2  px-1 my-0.5 rounded-md cursor-pointer hover:bg-gray-200">
                                    Fifteen accounts and login devices
                                </li>
                        ...
                        <div class="flex justify-between">
                            ...
                            <a href="register"> <button
                                    class=" py-1 px-4 mt-3 text-white text-sm rounded-2xl bg-[#b30059] hover:bg-[#7a204d]">Choose</button>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="lg-m:my-4 drop-shadow-lg md:ml-4">
                    <div class="bg-white pt-1  pb-3 w-full shadow relative  px-2 rounded-3xl ">
                        <div class=" absolute top-5 left-2 pointer-events-none inset-y-0 pl-3">
                            <img src="../../../public/img/crown.png" class="h-5 w-7 text-green-400" aria-hidden="true" />
                        </div>
                        <div class="pt-4 flex justify-center">
                        ...
                        <div class="h-[15rem] w-[16rem]">
                            <ul class="text-gray-500 text-sm">
                                ...
                                <li class="py-2 w-[16rem] xs px-1 my-0.5 rounded-md cursor-pointer hover:bg-gray-200">
                                    Everything
                                    included in business edition + custom number of accounts </li>
                        ...
                        <div>
                            <div class="flex justify-between items-end ">
                                ...
                                <div class=" bg-gray-300 flex justify-center  items-center py-1 px-4 text-sm rounded-full ">
                                    <p class="text-black">Contact Sales</p>
                                </div>

                                <a href="register">
                                    <button
                                        class=" py-1 px-4 text-sm rounded-2xl bg-[#b30059] hover:bg-[#7a204d] text-white">Contact</button>
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div
                        ...
                        <img class="h-96 w-full flex-none rounded-2xl object-cover shadow-xl lg:aspect-square lg:h-auto lg:max-w-sm"
                            src="../../../public/img/brainAiBig.png" alt="">
                        <div class="w-full flex-auto">
                            <h2 class="text-3xl font-bold tracking-tight text-white sm:text-4xl">Join us now</h2>
